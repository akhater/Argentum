...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            lut_processing::list_lut_libraries,
            lut_processing::create_lut_library,
            lut_processing::rename_lut_library,
            lut_processing::delete_lut_library,
            lut_processing::set_lut_library,
